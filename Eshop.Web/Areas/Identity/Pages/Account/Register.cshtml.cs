...
namespace Eshop.Web.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly SignInManager<EshopAppUser> _signInManager;
        ...
        public RegisterModel(
            UserManager<EshopAppUser> userManager,
            SignInManager<EshopAppUser> signInManager,
            RoleManager<EshopAppRoles> roleManager,
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (defaultrole != null)
                    {
                        ...
                        //dodavanje role na korisnik pri registracija
                    }
